  ...
  return (
    ...
    >
      ...
      <div className="relative h-52 overflow-hidden">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-t from-slate-900/90 via-slate-900/50 to-transparent opacity-70 group-hover:opacity-50 transition-opacity duration-500"></div>
        
        {/* Enhanced floating geometric shapes */}
        <div className="absolute top-4 right-4 w-8 h-8 border-2 border-emerald-400/60 rotate-45 opacity-0 group-hover:opacity-100 transition-all duration-500 group-hover:rotate-180 animate-pulse"></div>
        <div className="absolute bottom-4 left-4 w-4 h-4 bg-emerald-400/30 rounded-full opacity-0 group-hover:opacity-100 transition-all duration-300 animate-pulse"></div>
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-emerald-400/10 via-emerald-600/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700 pointer-events-none rounded-2xl"></div>
      
      {/* Subtle border glow */}
      <div className="absolute inset-0 rounded-2xl border border-emerald-400/0 group-hover:border-emerald-400/20 transition-all duration-500"></div>
    </div>
  );
};
